...
import ExperiencedHostInfoBox from '@/components/detailPage/hostDetail/ExperiencedHostInfoBox'
import HostIntro from '@/components/detailPage/hostDetail/HostIntro'
import BeginnerHostInfoBox from '@/components/detailPage/hostDetail/BeginnerHostInfoBox'
...
async function HostDetail({ id }) {
  ...
  return (
    <>
      <div className='mb-[1.2rem] mt-[1.2rem] text-[22px] font-semibold'>호스트 소개</div>
      <div>
        <div className='ml-[1rem]  flex h-[30rem] flex-row rounded-[17px]'>
          <div className='mr-[4rem] flex flex-row'>
            <div className='flex flex-col justify-around basis-1/3'>
              <div className='h-[14rem] w-96 flex-col justify-center rounded-[21px] bg-[white] shadow-host-detail-shadow'>
                {hostReviewCount === 0 ? (
                  <BeginnerHostInfoBox
